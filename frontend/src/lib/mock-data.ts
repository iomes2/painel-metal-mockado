...
export const MOCK_RELATORIOS: Record<string, ReportData[]> = {
  ...
  "OS-2024-002": [
    ...
    },
    {
      ...
      formData: {
        dataPte: createTimestamp("2025-06-12T00:00:00Z"),
        ordemServico: "OS-2024-002",
        nomeTrabalhador: "Ana Costa",
        localTrabalho: "Edifício Comercial - Cobertura",
        descricaoTrabalho: "Instalação de estrutura e trabalho em altura",
        riscoQuedaAltura: true,
        riscoQuedaObjetos: true,
        soldaAmbienteAdequado: "S",
        soldaRotasFuga: "S",
      },
      photoUrls: [],
      submittedBy: "mg02",
    ...
    },
    {
      ...
      formData: {
        ...
        ordemServico: "OS-2024-002",
        gerenteObra: "Maria Oliveira",
        numeroRNC: "2024-002/01",
        tipoAcao: "corretiva",
        descricaoProblema: "Peças metálicas (perfis W) entregues com arranhões profundos na pintura e sem a documentação de rastreabilidade do lote.",
        dataOcorrencia: createTimestamp("2025-06-11T00:00:00Z"),
        localOrigem: "Canteiro - Recebimento",
        acaoCorretivaImediata: "Isolamento do lote no canteiro e notificação da transportadora.",
        acaoTomadaOQue: "Devolver as peças avariadas ao fornecedor",
        acaoTomadaQuem: "Maria Oliveira",
        acaoTomadaQuando: createTimestamp("2025-06-15T00:00:00Z"),
        acaoTomadaOnde: "Canteiro de obras",
        solucaoEficaz: "N",
        envolvidosCientes: "S",
      },
      photoUrls: [],
